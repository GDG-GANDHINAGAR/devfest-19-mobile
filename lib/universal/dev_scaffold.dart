...
import 'package:devfest_gandhinagar/config/config_bloc.dart';
import 'package:devfest_gandhinagar/config/config_event.dart';
            ...
            actions: <Widget>[
              ...
              IconButton(
                onPressed: () => Share.share(
                    "Download the new GDG Gandhinagar DevFest App and share with your tech friends.\nPlayStore -  http://bit.ly/2GDr18N"),
                icon: Icon(
                  Icons.share,
                  size: 20,
                ),
